...
This website hosts current and past projects on network meta-analysis that I led as principal investigator, and related publications and conference presentations. You can also read my ongoing [research journey](/loukiaspineli.netlify.app/biography/biography/), my short resumé below, and a list of publications and conference presentations accumulated since my PhD studies.

{{< icon name="download" pack="fas" >}} Download my {{< staticref "authors/admin/uploads/Curriculum Vitae_Spineli.pdf" "newtab" >}}resumé{{< /staticref >}}.
